...
import com.babbiunplugged.reactive.demo.constants.ItemConstants;
...
public class ItemHandlerTest {
	...
	public void runTimeException() {
		...
		webTestClient.get().uri("/fun/runtimeexception").exchange().expectStatus().is5xxServerError().expectBody()
